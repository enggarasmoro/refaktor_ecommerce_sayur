    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">User Admin</h4>
            ...
            <form id="form" class="parsley-admin">
                ...
                <div class="modal-body p-4">
                    <?php $value = (isset($admin->id))?$admin->id:""; ?>
                    <input type="hidden" name="id" value="{{$value}}">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php $value = (isset($admin->username))?$admin->username:""; ?>
                                <label class="required font-weight-bold text-dark text-2">Username</label>
                                <input type="text"  id="username" name="username" class="form-control"  value="{{ $value }}" parsley-trigger="change" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php $value = (isset($admin->name))?$admin->name:""; ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php $value = (isset($admin->email))?$admin->email:""; ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php $value = (isset($admin->nohp))?$admin->nohp:""; ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="password" minlength="8"  id="password" name="password" class="form-control" parsley-trigger="change" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script type="text/javascript">
    ...
    $("#form").on("submit", (function(b) {
        ...
        var type = "{{$type}}";
        if (type == "simpan") {
            url = "{{route('masteradmin.create')}}"
        } else {
            url = "{{route('masteradmin.edit')}}"
        }
        $.ajax({
            url: url,
            type: "POST",
            ...
            success: function(data) {
                ...
                if (data.errorsvalidation) {
                    ...
                    Swal.fire({
                        ...
                        $('#master_admin').DataTable().ajax.reload();
                    });
                } else {
                    $("#myModal").modal("hide");
                    Swal.fire({
