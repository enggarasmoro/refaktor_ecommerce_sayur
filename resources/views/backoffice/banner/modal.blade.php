        ...
        <div class="modal-content">
            ...
            <form id="form" class="parsley-banner">
                ...
                <div class="modal-body p-4">
                    <?php $value = (isset($banner->id))?$banner->id:""; ?>
                    <input type="hidden" name="id" value="{{$value}}">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php $value = (isset($banner->name))?$banner->name:""; ?>
                                <label class="required font-weight-bold text-dark text-2">nama Banner</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="required font-weight-bold text-dark text-2">Gambar Banner</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php $value = (isset($banner->status))?$banner->status:""; ?>
...
<script type="text/javascript">
    ...
    $("#form").on("submit", (function(b) {
        ...
        var type = "{{$type}}";
        if (type == "simpan") {
            url = "{{route('masterbanner.create')}}"
        } else {
            url = "{{route('masterbanner.edit')}}"
        }
        $.ajax({
            url: url,
            type: "POST",
            ...
            success: function(data) {
                ...
                if (data.errorsvalidation) {
                    ...
                    Swal.fire({
                        ...
                        $('#master_banner').DataTable().ajax.reload();
                    });
                } else {
                    $("#myModal").modal("hide");
                    Swal.fire({
