        ...
        <div class="modal-content">
            ...
            <form id="form" class="parsley-kategori">
                ...
                <div class="modal-body p-4">
                    <?php $value = (isset($kategori->id))?$kategori->id:""; ?>
                    <input type="hidden" name="id" value="{{$value}}">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php $value = (isset($kategori->nama))?$kategori->nama:""; ?>
...
<script type="text/javascript">
    ...
    $("#form").on("submit", (function(b) {
        ...
        var type = "{{$type}}";
        if (type == "simpan") {
            url = "{{route('produkkategori.create')}}"
        } else {
            url = "{{route('produkkategori.edit')}}"
        }
        $.ajax({
            url: url,
            type: "POST",
            ...
            success: function(data) {
                ...
                if (data.errorsvalidation) {
                    ...
                    Swal.fire({
                        ...
                        $('#produk_kategori').DataTable().ajax.reload();
                    });
                } else {
                    $("#myModal").modal("hide");
                    Swal.fire({
