    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <?php if ($order->harga_package != 0) { ?>
                            <tr>
                                <td colspan="3">Biaya Penggemasan</td>
                                <td> <?php echo "Rp " . number_format($order->harga_package); ?></td>
                            </tr>
                        <?php } ?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect waves-light" id="print">Print</button>
            </div>
        </div>
    </div>
</div>
